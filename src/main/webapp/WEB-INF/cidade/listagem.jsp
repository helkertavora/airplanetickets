...
<body>
	...
	<section id="sessao-cidade">
		<jsp:include page="tabela-cidade.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-cidade.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/cidade/cidade.js"></script>
</html>