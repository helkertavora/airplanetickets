...
<body>
	...
	<section id="sessao-aeroporto">
		<jsp:include page="tabela-aeroporto.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-aeroporto.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/aeroporto/aeroporto.js"></script>
</html>