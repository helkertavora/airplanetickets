...
<body>
	...
	<section id="sessao-reserva">
		<jsp:include page="tabela-reserva.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-reserva.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/reserva/reserva.js"></script>
</html>