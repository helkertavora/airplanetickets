...
<body>
	...
	<section id="sessao-passagem">
		<jsp:include page="tabela-passagem.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-passagem.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/passagem/passagem.js"></script>
</html>