...
<c:set var="path" value="${pageContext.request.contextPath}" scope="request"/>
	...
	<style type="text/css">
		@IMPORT url("${path}/static/css/datepicker.css");
...
<body>
	...
	<section id="sessao-passageiro">
		<jsp:include page="tabela-passageiro.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-passageiro.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/passageiro/passageiro.js"></script>
</html>