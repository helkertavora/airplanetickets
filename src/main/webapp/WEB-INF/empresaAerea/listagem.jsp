...
<body>
	...
	<section id="sessao-empresaAerea">
		<jsp:include page="tabela-empresaAerea.jsp"></jsp:include>
	</section>
	<jsp:include page="modal-empresaAerea.jsp" />
	</div>
</body>
...
<script src="${path}/static/js/empresaAerea/empresaAerea.js"></script>
</html>